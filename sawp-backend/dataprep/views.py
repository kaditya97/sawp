...
class ClipRasterViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request):
        ...
        file_path = shapefile(output_raster, file_name+'_clipped.tif')
        ClipRaster.objects.create(name=file_name, file_name=file_name+'_clipped.tif', file='dataprep/clipraster/'+file_name+'_clipped.tif')
        geo.create_coveragestore(layer_name=file_name+'_clipped', path=file_path, workspace='sawp')
